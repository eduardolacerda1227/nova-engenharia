        ...
        >
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-md bg-[#25D366] px-6 py-3 font-display text-sm font-semibold uppercase tracking-wide text-white shadow-md transition hover:bg-[#20bd5a]"
            >
              <svg

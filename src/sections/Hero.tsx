        ...
        >
          <div className="pb-2">
            <div className="relative inline-block">
              <span
                className="pointer-events-none absolute -inset-6 rounded-3xl bg-nova-gold/10 blur-2xl"
                aria-hidden
              />
              <Logo className="relative h-24 w-auto max-w-[min(100%,320px)] object-contain drop-shadow-[0_0_30px_rgba(201,162,39,0.45)] sm:h-28 md:h-32 md:max-w-[380px]" />
            </div>
          </div>
